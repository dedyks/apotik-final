                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      <div class="form-group"><label class="col-lg-2 control-label">Tujuan</label>
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="tujuan" value="<?php echo $tujuan ?>" class="form-control"> <span class="help-block m-b-none">Tujuan mutasi barang.</span>
                        </div>
      </div>

                        <div class="form-group"><label class="col-lg-1 control-label">Item</label>

                            <div class="col-lg-5"><input type="text" id="search" name="item" class="form-control"> <span class="help-block m-b-none"></span>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      <span class="label label-Primary"><?php echo $row->lokasi ?></span>
                                ...
                                <td><a class="btn" href="<?php echo base_url().'mutasi/ulang/'.$row->id ?>"><i class="fa fa-trash"></i></a>
                                </td>
